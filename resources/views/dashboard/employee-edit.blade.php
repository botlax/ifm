...
@component('dashboard.partials.content')
	...
	@endslot
	@slot('content')
		{!! Form::model($emp,['route' => ['emp-update',$emp->id],'id' => 'emp-add']) !!}
        <div class="row clearfix">
            <div class="5u">
        		...
        		<div>            
        			...
        			{!! Form::select('nationality', $nats, $emp->nationality?strtolower($emp->nationality):null) !!}
        		...
        		<div>            
        			...
        			{!! Form::text('dob', $emp->dob?strtolower($emp->dob):null,['placeholder'=>'yyyy-mm-dd']) !!}
        			@if ($errors->has('dob'))
                        <span class="error">
